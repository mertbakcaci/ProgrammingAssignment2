## Matrix inversion is usually a costly computation and it is very useful to caching the inverse of a matrix rather than compute it repeatedly.
...
## If the inverse of this matrix has already been calculated, then the function should retrieve the inverse from the cache.
